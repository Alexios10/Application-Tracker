...
const StatsCards = ({ total, rejected, pending }: StatsCardsProps) => {
  return (
    <div className="grid gap-4 sm:grid-cols-3">
      <div className="relative overflow-hidden rounded-2xl border border-sky-500/30 bg-gradient-to-br from-sky-500/80 via-emerald-400/80 to-sky-500/70 p-5 text-slate-950 shadow-xl">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs font-semibold uppercase text-slate-900/80">
              Søknader sendt
            </p>
      ...
      <div className="rounded-2xl border border-red-500/25 bg-gradient-to-br from-red-500/10 via-slate-900/40 to-slate-900/70 p-5 text-slate-100 shadow-lg">
        <div className="flex items-center justify-between">
          <div>
      ...
      <div className="rounded-2xl border border-amber-400/25 bg-gradient-to-br from-amber-400/15 via-slate-900/40 to-slate-900/70 p-5 text-slate-100 shadow-lg">
        <div className="flex items-center justify-between">
          <div>
